...
async function main() {
  ...
  const goosebumpsStakingWithReflection = await GoosebumpsStakingWithReflection.deploy(_stakeToken, _rewardsToken, _treasury, _rewardWallet, _rewardPerBlockTokenN, _rewardPerBlockTokenD);
